...
var ScrollbarSize = function (_Component) {
	...
	function ScrollbarSize() {
		...
		return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = ScrollbarSize.__proto__ || (0, _getPrototypeOf2.default)(ScrollbarSize)).call.apply(_ref, [this].concat(args))), _this), _this.setMeasurements = function () {
			_this.measurements = {
				scrollbarHeight: _this.node.offsetHeight - _this.node.clientHeight,
				scrollbarWidth: _this.node.offsetWidth - _this.node.clientWidth
			};
		}, _this.handleResize = (0, _lodash4.default)(function () {
			var onChange = _this.props.onChange;


			var prevMeasurements = _this.measurements;
			_this.setMeasurements();
			if (!(0, _lodash2.default)(prevMeasurements, _this.measurements)) {
				onChange(_this.measurements);
			}
	...
	(0, _createClass3.default)(ScrollbarSize, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				null,
				onChange ? _react2.default.createElement(_reactEventListener2.default, {
					target: 'window',
